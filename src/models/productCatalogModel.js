  ...
  return {
    ...
    hero: {
      ...
      description: [
        ...
        "Но есть и другой, более простой и понятный путь, объединяющий в себе все преимущества – локальный российский производитель, без конвейера и массовых тиражей, делающий эксклюзивные вещи, слышащего вас и вашего клиента, способный выдать высокое качество в кратчайшие сроки."
      ],
      highlight:
    ...
    actions: {
      ...
      catalogPdfHref: ["/files/ufo-catalog.pdf", "/files/dea-catalog.pdf"]
    },
    requestDrawer: {
