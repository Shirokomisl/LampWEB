...
const CATALOG_PRODUCTS = [
  ...
  },
  {
    ...
    description: "Dea — торшер с выразительной скульптурной формой, построенной на точном балансе пропорций, изгиба и материалов. Лаконичная конструкция с матово-сатиновой поверхностью и акцентным латунным элементом создаёт ощущение архитектурной лёгкости, превращая светильник в самостоятельный арт-объект интерьера.",
    paragraph1: "Дизайн Dea вдохновлён идеей гармонии и равновесия: плавная линия стойки и выверенные пропорции формируют утончённый силуэт, который естественно притягивает внимание и становится композиционным центром пространства.",
    paragraph2: "Премиальная ткань абажура мягко рассеивает свет, создавая атмосферное освещение и подчёркивая благородство материалов. Торшер органично дополняет современные и минималистичные интерьеры, добавляя им статусный и выразительный характер."
  }
];
